define(['athena', 'tweenmax', 'jquery.mousewheel'], function() {
    var view = Athena.view.BaseView.extend({
        ...
        _touchDragOn: function() {
            $(document).on('touchmove', {self: this}, this._touchMove);
            $(document).on('touchend', {self: this}, this._touchEnd);
        },
        ...
        _dragOn: function() {
            $(document).on('mousemove', {self: this}, this._mouseMove);
            $(document).on('mouseup', {self: this}, this._mouseUp);
        },
        _dragOff: function() {
